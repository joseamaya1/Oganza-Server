...
int main(int argc, char* argv[])
{
	...
	if (serviceManager.is_running()) {
		std::cout << ">> " << g_config.getString(ConfigManager::SERVER_NAME) << " Online!" << std::endl << std::endl;
		serviceManager.run();
	} else {
...
void mainLoader(int argc, char* argv[], ServiceManager* services)
{
...
#endif
	std::cout << "The " << STATUS_SERVER_NAME << " Version: (" << STATUS_SERVER_VERSION << "." << MINOR_VERSION << ")" << std::endl;
	...
	std::cout << "Servidor compilado por " << STATUS_SERVER_DEVELOPERS << "." << std::endl;
	std::cout << "Visite meu forum: " << GIT_REPO <<"." << std::endl;
	std::cout << std::endl;
	...
	std::cout << ">> Tudo carregado com sucesso, iniciando o servidor..." << std::endl;
