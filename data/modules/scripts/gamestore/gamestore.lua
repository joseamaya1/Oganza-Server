...
GameStore.Categories = {
	{
		...
		offers = {
			...
			{name = "Indefinido", state = GameStore.States.STATE_NEW, thingId = {male=1024,female=1023}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 750, icons = {"indefinido.png", "indefinido2.png"}},
