...
BOMBERMAN_MINIGAME = {
    ...
    bomb_up_item = {itemid = 15622, up = 1},
    ...
    messages = {
        ...
        bomb_kill = {msg = "[BOMBERMAN] You kill %s.", type = MESSAGE_EVENT_ADVANCE},
        bomb_death = {msg = "[BOMBERMAN] You are death! %s has killed you.", type = MESSAGE_EVENT_ADVANCE},
        bomb_suicide = {msg = "[BOMBERMAN] You committed suicide.", type = MESSAGE_EVENT_ADVANCE},
        movement_powerup = {msg = "[BOMBERMAN] You got a powerup!", type = MESSAGE_EVENT_ADVANCE},
        press_lever_enter = {msg = "[BOMBERMAN] Welcome to the Bomberman Minigame, to place a bomb type !bomb.", type = MESSAGE_EVENT_ADVANCE},
        press_lever_no_map = {msg = "[BOMBERMAN] No map is available at the moment.", type = MESSAGE_EVENT_ADVANCE},
        press_lever_no_players = {msg = "[BOMBERMAN] You need more players to play Bomberman.", type = MESSAGE_EVENT_ADVANCE},
        press_lever_rebuilding_map = {msg = "[BOMBERMAN] No map is available at the moment, wait the map rebuilding finish.", type = MESSAGE_EVENT_ADVANCE},
        press_lever_no_money = {msg = "[BOMBERMAN] You need %d gold to play Bomberman.", type = MESSAGE_EVENT_ADVANCE},
        press_lever_cant_play = {msg = "[BOMBERMAN] You can't play Bomberman.", type = MESSAGE_EVENT_ADVANCE},
        talkaction_not_in_minigame = {msg = "[BOMBERMAN] You need stay in the Bomberman Minigame to use this command.", type = MESSAGE_EVENT_ADVANCE},
        talkaction_dont_have_bombs = {msg = "[BOMBERMAN] You don't have more bombs.", type = MESSAGE_EVENT_ADVANCE},
        talkaction_cant_place_bomb = {msg = "[BOMBERMAN] You can't place a bomb here.", type = MESSAGE_EVENT_ADVANCE}, 
        talkaction_place_bomb = {msg = "[BOMBERMAN] You place a bomb. Bombs remaining: %d.", type = MESSAGE_EVENT_ADVANCE},
        talkaction_death_place_bomb = {msg = "[BOMBERMAN] You are death, you can't place a bomb.", type = MESSAGE_EVENT_ADVANCE},
    ...
    player_tiles = {
        [1] = Position(1025, 1058, 6),
        [2] = Position(1026, 1058, 6),
        [3] = Position(1026, 1058, 6),
        [4] = Position(1026, 1058, 6),
    ...
    maps = {
        [1] = {
            player_death_spec_pos = Position(1027, 1032, 6),
            players_positions = {
                [1] = Position(1020, 1026, 7),
                [2] = Position(1020, 1036, 7),
                [3] = Position(1020, 1036, 7),
                [4] = Position(1020, 1036, 7),
            }
        }
...
function Position:bombermanExplode(defpos, player)
    ...
    for i = 1, tile:getItemCount() do
        ...
        elseif item[i]:getId() == BOMBERMAN_MINIGAME.bomb_id and defpos ~= self then
            ...
            end, BOMBERMAN_MINIGAME.explode_other_bomb_interval)
