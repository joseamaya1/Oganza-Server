local table = 
{
	...
	[60] = {type = "mount", id = {32, 0}, msg = "Voce ganhou uma montaria!"},
      [100] = {type = "mount", id = {12, 0}, msg = "Voce ganhou uma montaria!"},
      [150] = {type = "mount", id = {106, 0}, msg = "Voce ganhou uma montaria!"},
