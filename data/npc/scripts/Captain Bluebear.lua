...
addTravelKeyword('ethno', 0, Position(31674, 32070, 6))
addTravelKeyword('gengia', 0, Position(31203, 32005, 6))
addTravelKeyword('ghala', 0, Position(30675, 31993, 6))
addTravelKeyword('ghenov', 0, Position(29920, 32077, 6))
addTravelKeyword('oken', 0, Position(29355, 31833, 6))
addTravelKeyword('pyre', 0, Position(28735, 31912, 6))
addTravelKeyword('vikia', 0, Position(28257, 31821, 6))
addTravelKeyword('atlantyda', 0, Position(431, 297, 6))addTravelKeyword('sphere', 0, Position(10202, 10074, 6))
addTravelKeyword('arumha', 0, Position(10079, 11363, 6))
...
keywordHandler:addKeyword({'trip'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {Oramond},  {Vikia},  {Ethno},  {Gengia},  {Ghala},  {Ghenov},  {Oken},  {Pyre},  {Sphere}, {Arumha}, {Atlantyda} or {Edron}?'})
keywordHandler:addKeyword({'route'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {Oramond},  {Vikia},  {Ethno},  {Gengia},  {Ghala},  {Ghenov},  {Oken},  {Pyre},  {Sphere}, {Arumha}, {Atlantyda} or {Edron}?'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {Oramond},  {Vikia},  {Ethno},  {Gengia},  {Ghala},  {Ghenov},  {Oken},  {Pyre},  {Sphere}, {Arumha}, {Atlantyda} or {Edron}?'})
keywordHandler:addKeyword({'town'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {Oramond},  {Vikia},  {Ethno},  {Gengia},  {Ghala},  {Ghenov},  {Oken},  {Pyre},  {Sphere}, {Arumha}, {Atlantyda} or {Edron}?'})
keywordHandler:addKeyword({'destination'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {Oramond},  {Vikia},  {Ethno},  {Gengia},  {Ghala},  {Ghenov},  {Oken},  {Pyre},  {Sphere}, {Arumha}, {Atlantyda} or {Edron}?'})
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {Oramond},  {Vikia},  {Ethno},  {Gengia},  {Ghala},  {Ghenov},  {Oken},  {Pyre},  {Sphere}, {Arumha}, {Atlantyda} or {Edron}?'})
keywordHandler:addKeyword({'go'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {Oramond},  {Vikia},  {Ethno},  {Gengia},  {Ghala},  {Ghenov},  {Oken},  {Pyre},  {Sphere}, {Arumha}, {Atlantyda} or {Edron}?'})
